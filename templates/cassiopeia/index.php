...
$doc->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/mod_articles_latest.css');
...
?>">
    ...
    <?php if ($this->countModules('footer', true)) : ?>
        <footer class="container-fluid footer full-width">
            ...
            <?php if ($this->countModules('bottom-b', true)) : ?>
                <div class="col-md-6 pt-1">
                    <h5  style="border-bottom: 1px solid rgba(255, 255, 255, 0.06);; padding: 5px;">GET Involved</h5>
